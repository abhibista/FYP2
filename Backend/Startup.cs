...
namespace Book
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<IDoctorData, MockAdminData>();
            services.AddScoped<IDoctorData, MockAdminData>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Thsi part is for mapping routes of api of postman or any other ajax request
